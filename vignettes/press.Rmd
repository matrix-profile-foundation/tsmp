...
### Performance on an Intel(R) Core(TM) i7-7700 CPU @ 3.60GHz using a toy dataset

```{r table1, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
|  | Elapsed Time^[These are results using only R code, no low-level C code optimizations] | Data size | Window size | Cores |
|-----------|:------------:|:---------:|:-----------:|:-------:|
