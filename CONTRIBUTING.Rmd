...
The goal of this guide is to help you contribute to tsmp as quickly and as easily possible. The guide is divided into two main pieces:
...
1.  **Packages** should be loaded at the top of the script, so it's easy to
    ...
    it, please don't include the output of `sessionInfo()`

1.  The easiest way to include **data** is to use `dput()` to generate the R code to recreate it. For example, to recreate the `mtcars` dataset in R, I'd perform the following steps:
...
*   You should always add a bullet point to `NEWS.Rmd` motivating the change.
