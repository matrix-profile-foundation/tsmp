...
#'
#' @examples
#' plot_arc(pairs = matrix(c(5, 10, 1, 10, 20, 5), ncol = 2, byrow = TRUE))
plot_arc <- function(mp, pi, window_size, exclusion_zone = 5, edge_limit = 5, threshold = quantile(mp, 0.1), pairs = NULL, alpha = NULL, quality = 30,
