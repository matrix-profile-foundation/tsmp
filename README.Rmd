...
Please refer to the [User Manual](https://franzbischoff.github.io/tsmp/reference/) for more details.
...
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/franzbischoff/tsmp/blob/master/CODE_OF_CONDUCT.md). By participating in this project, you agree to abide by its terms.
