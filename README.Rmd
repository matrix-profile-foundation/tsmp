...
mbm_stomp <- round(microbenchmark::microbenchmark(tsmp(data, window_size = w, mode = "stomp", verbose = 0), times = 1L)$time / 10^9, 2)
mbm_stomp_par <- round(microbenchmark::microbenchmark(tsmp(data, window_size = w, mode = "stomp", n_workers = workers, verbose = 0), times = 1L)$time / 10^9, 2)
mbm_scrimp <- round(microbenchmark::microbenchmark(tsmp(data, window_size = w, mode = "scrimp", verbose = 0), times = 1L)$time / 10^9, 2)
mbm_stamp <- round(microbenchmark::microbenchmark(tsmp(data, window_size = w, mode = "stamp", verbose = 0), times = 1L)$time / 10^9, 2)
mbm_stamp_par <- round(microbenchmark::microbenchmark(tsmp(data, window_size = w, mode = "stamp", n_workers = workers, verbose = 0), times = 1L)$time / 10^9, 2)
